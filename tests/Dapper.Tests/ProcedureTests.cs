...
namespace Dapper.Tests
{
    ...
    {
        public SystemSqlClientProcedureTests(SystemSqlClientProvider provider) : base(provider) { }
    }
#if MSSQLCLIENT
    [Collection("ProcedureTests")]
    public sealed class MicrosoftSqlClientProcedureTests : ProcedureTests<MicrosoftSqlClientProvider>
    {
        public MicrosoftSqlClientProcedureTests(MicrosoftSqlClientProvider provider) : base(provider) { }
    }
#endif
    public abstract class ProcedureTests<TProvider> : TestBase<TProvider> where TProvider : DatabaseProvider, new()
    {
        protected ProcedureTests(TProvider provider) : base(provider) { }
